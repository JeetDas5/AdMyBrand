...
const FeatureCard = ({ 
  ...
  return (
    <GlassmorphicCard 
      className={`p-6 h-full animate-fade-in-up ${animationDelay}`}
      hoverEffect={true}
    >
    ...
    <section id="features" className="py-20 relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Powerful Features to Supercharge Your Advertising</h2>
          <p className="text-xl text-foreground/70">
            Our AI-powered platform provides everything you need to create, manage, and optimize your advertising campaigns.
          </p>
        </div>
