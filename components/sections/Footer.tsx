...
export default function Footer() {
  ...
  return (
    <footer className="bg-blue-50 dark:bg-gray-900 pt-16 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-foreground/70 mb-6 max-w-md">
              AdMyBrand uses cutting-edge AI to create, optimize, and manage your advertising campaigns across all platforms.
            </p>
        ...
        {/* Bottom section */}
        <GlassmorphicCard className="p-6 mt-8">
